...
OWNER_ID = int(getenv("OWNER_ID", "5682328579"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Professorgurubar")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5682328579").split()))
